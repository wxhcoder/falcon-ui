import { notNullish, toArray, tryOnScopeDispose, unrefElement } from './chunk-6FZ35DRC.js'
import { computed, shallowRef, toValue, watch } from './chunk-6XXLIVGJ.js'
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        ...
        var insideShadowRoot =
          typeof ShadowRoot !== 'undefined' && container.getRootNode() instanceof ShadowRoot
        ...
        while (current) {
          ...
          if (parent) {
            ...
            insideShadowRoot =
              typeof ShadowRoot !== 'undefined' && parent.getRootNode() instanceof ShadowRoot
          }
